...
class HomeScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        background_image = display_image("backgrounds/main_background.jpg", self.background_size)
...
class MainScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        main_background = display_image("backgrounds/backgroundFrameMockup.jpg")
