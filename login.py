...
class LoginPage:
    def __init__(self, window, on_login_success):
        self.window = window
        ...
        self.username_entry = tk.Entry(self.login_frame, highlightthickness=0, bd=0)
        ...
        self.password_entry = tk.Entry(self.login_frame, show="*", highlightthickness=0, bd=0)
